...
export const InfoBanner = () => {
	...
	return (
		<Banner
			...
			onClose={() => {
				sessionStorage.setItem('hideInfoBanner', 'true');
				setShowBanner(false);
			}}
		>
			<svg
			...
			<p>
				<Trans
					i18nKey="infoBanner.content"
					components={{
						1: (
							//Is intentionally empty because Trans injects the translated text as children at runtime.
							/* eslint-disable-next-line jsx-a11y/anchor-has-content */
							<a
								href="https://www.diakonie.de/informieren/informationen-zum-online-beratungsportal-der-diakonie"
								target="_blank"
